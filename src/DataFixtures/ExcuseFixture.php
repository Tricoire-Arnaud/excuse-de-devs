<?php
// src/DataFixtures/ExcuseFixture.php
...
class ExcuseFixture extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($excusesData as $excuseData) {
            $excuse = new Excuse();
            $excuse->setHttpCode($excuseData['http_code']);
            $excuse->setTag($excuseData['tag']);
            $excuse->setMessage($excuseData['message']);
